...
Werden zum Beispiel von zwei Erregern Wellen an einer Wasseroberfläche erzeugt, so überlagern sich diese. Genau in der Mitte zwischen diesen befindet sich bei gleicher Phase der Erreger stets ein Wellenbauch. Das liegt daran, dass der von beiden Erregern aus zurückgelegte Weg gleich lang ist und damit an diesem Punkt der Gangunterschied Null ist. Links und rechts von diesem Punkt bildet sich alle halbe Wellenlänge erneut ein Wellenbauch. Dazwischen sind Wellenknoten.
