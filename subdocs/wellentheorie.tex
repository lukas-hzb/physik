...
Ein klassisches Beispiel für stehende Wellen mit ist die schwingende Saite eines Musikinstruments. Die an beiden Enden fixierte Saite reflektiert die Wellen, wodurch stehende Wellen mit Knoten an den Enden entstehen. Je nach Frequenz bilden sich verschiedene Muster, von der Grundschwingung mit einem Bauch bis zu höheren Moden mit mehreren Knoten und Bäuchen.

Auch in Rohren mit offenen oder geschlossenen Enden kommt es zu stehenden Wellen. Mit Knoten und Bäuchen verhält es sich ähnlich wie bei der schwingenden Saite. \hyperref[sec:eigenschwingungen_mit_festen_und_losen_Enden]{Eigenschwingungen mit festen und losen Enden}

Werden zum Beispiel von zwei Erregern Wellen an einer Wasseroberfläche erzeugt, überlagern sich diese zu einem Interferenzmuster. Am Punkt genau zwischen den beiden Erregern ist der Weg von beiden Erregern aus gleich lang, sodass der Gangunterschied $\delta = 0$ beträgt und ein Wellenbauch entsteht (konstruktive Interferenz).
